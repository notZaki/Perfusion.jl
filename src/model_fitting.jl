...
const model_dict = Dict{Symbol,Dict{Symbol,Function}}(
    :tofts => Dict{Symbol,Function}(:lls => fit_tofts_lls, :nls => fit_tofts_nls),
    :extendedtofts => Dict{Symbol,Function}(
        :lls => fit_extendedtofts_lls,
        :nls => fit_extendedtofts_nls,
    ),
    :uptake => Dict{Symbol,Function}(:lls => fit_uptake_lls, :nls => fit_uptake_nls),
    :exchange => Dict{Symbol,Function}(:lls => fit_exchange_lls, :nls => fit_exchange_nls),

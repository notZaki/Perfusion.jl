function model_filtration(conv::Function=expconv; t::AbstractVector, parameters::NamedTuple, ca::AbstractVector)
...
function fit_filtration_nls(conv::Function=expconv;
    t::AbstractVector, ca::AbstractVector, ct::AbstractArray, mask=true)
